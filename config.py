...
# Rounds leave the turret muzzle (~0.9*CAR_SCALE above the chassis centre) and
# fly a constant height above the road surface so they follow hills and curves
# instead of burying into the tarmac on elevated sections.
GUN_MUZZLE_Z = 13.0            # muzzle height above the chassis centre
BULLET_FLY_HEIGHT = CAR_GROUND_Z + GUN_MUZZLE_Z   # height above the terrain
ENEMY_MAX_LIVES = 8
PLAYER_MAX_LIVES = 10
JUMP_HEIGHT_MAX = 22
JUMP_DURATION = 0.8
